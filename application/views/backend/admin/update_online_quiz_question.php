...
$online_quiz_details = $this->db->get_where('online_quiz', array('online_quiz_id' => $question_details['online_quiz_id']))->row_array();

$added_question_info = $this->db->get_where('question_bank', array('online_quiz_id' => $online_quiz_details['online_quiz_id']))->result_array();
...
<div class="row">
    <div class="col-md-12">
        <?php echo form_open(site_url('admin/update_online_quiz_question/' . $param2 . '/update' . '/' . $question_details['online_quiz_id']), array('class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top')); ?>
