...
<div class="col-sm-12">
    <div class="panel panel-info">
        <div class="panel-body table-responsive">
          ...
          <hr>
        <?php echo form_open(site_url('admin/manage_online_quiz/create') , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <select name="class_id" id = "class_id" class="form-control selectboxit"
                            onchange="return get_class_topic_subject(this.value)" required>
                ...
                <div id="topic_subject_selection_holder"></div>


                <div class="form-group">
                    <label class="col-md-12" for="example-text"><?php echo get_phrase('quiz_date');?></label>
                    <div class="col-sm-12">
                        <input class="form-control m-r-10" name="quiz_date" type="date" value="<?php echo date('Y-m-d') ?>" id="example-date-input" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <textarea rows="5" name="instruction" class="form-control" placeholder="please specify quiz instructions here" ></textarea>
                    </div>
                </div>

                <div class="form-group">
                    <button type="submit" class="btn btn-info btn-rounded btn-block btn-sm"><i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('add_quiz'); ?></button>
                </div>
            </form>
        </div>
    </div>
