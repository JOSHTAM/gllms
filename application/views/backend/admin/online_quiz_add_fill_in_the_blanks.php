...
<?php echo form_open(site_url('admin/manage_online_quiz_question/' . $online_quiz_id . '/add/fill_in_the_blanks'), array('class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top')); ?>
