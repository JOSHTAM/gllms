<?php $online_quiz_details = $this->db->get_where('online_quiz', array('online_quiz_id' => $online_quiz_id))->row_array();
    ...
    <div class="col-sm-12">
        <div class="panel panel-info">
            <div class="panel-body table-responsive">
                ...
                <a href="<?php echo base_url(); ?>admin/manage_online_quiz"><button type="button" class="btn btn-defualt btn-xs pull-right"><i class="fa fa-mail-reply-all"></i>
                        &nbsp;back</button></a>

                <hr>

                <!-- THIS topic IS FOR THE QUESTION LIST -->
                <div class="row">
                    <div class="col-sm-6">
                        <div class="panel panel-info">
                            <div class="panel-body table-responsive">
                                            ...
                                            foreach ($added_question_info as $key => $added_question) : ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <!-- <a href="<?php echo site_url('admin/update_online_quiz_question/' . $added_question['question_bank_id']); ?>" class = "btn btn-primary btn-xs" data-toggle="tooltip" title="<?php echo get_phrase('edit'); ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a> -->
                                                        <a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/update_online_quiz_question/' . $added_question['question_bank_id']); ?>')" class="btn btn-circle btn-info btn-xs" data-toggle="tooltip" title="<?php echo get_phrase('edit'); ?>"><i class="fa fa-pencil" aria-hidden="true" style="color:white"></i></a>
                                                        <a href="#" onclick="confirm_modal('<?php echo site_url('admin/delete_question_from_online_quiz/' . $added_question['question_bank_id']); ?>');" class="btn btn-circle btn-danger btn-xs" data-toggle="tooltip" title="<?php echo get_phrase('delete'); ?>" style="color:white"><i class="fa fa-times" aria-hidden="true"></i></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                    ...
                    <!-- THIS topic IS FOR THE quiz DETAILS -->
                    <div class="col-sm-6">
                        <div class="panel panel-info">
                            <div class="panel-body table-responsive">
                                <i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo get_phrase('quiz_details'); ?>
                                <hr>

                                <table class="table">
                                    <tbody>
                                        <tr>
                                            <td><b><?php echo get_phrase('quiz_title'); ?></b></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $this->db->get_where('class', array('class_id' => $online_quiz_details['class_id']))->row()->name; ?></td>
                                            <td><b><?php echo get_phrase('time'); ?></b></td>
                                            <td><?php echo $online_quiz_details['time_start'] . '-' . $online_quiz_details['time_end']; ?></td>
                                        </tr>
                                        <tr>
                                            <td><b><?php echo get_phrase('topic'); ?></b></td>
                                            <td><?php echo $this->db->get_where('topic', array('topic_id' => $online_quiz_details['topic_id']))->row()->name; ?></td>
                        ...
                        <!-- THIS topic IS FOR ADDING NEW QUESTIONS -->
                        <div class="panel panel-info">
                            <div class="panel-body table-responsive">
                                ...
                                <br><br>
                                <div id="fill_in_the_blanks" style="display: none"><?php include 'online_quiz_add_fill_in_the_blanks.php'; ?></div>
                                <div id="multiple_choice" style="display: none"><?php include 'online_quiz_add_multiple_choice.php'; ?></div>
                                <div id="true_false" style="display: none"><?php include 'online_quiz_add_true_false.php'; ?></div>
